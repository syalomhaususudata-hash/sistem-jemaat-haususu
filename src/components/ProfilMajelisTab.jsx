...
export default function ProfilMajelisTab({
  ...
  handleExportCSV, fileInputRef, handleCleanAll,
  // Infografis
            ...
            <div className="p-6 border-b border-gray-100 flex flex-col xl:flex-row xl:items-center justify-between gap-4 print:hidden">
              <div className="flex flex-wrap items-center gap-3">
                <h2 className="text-xl font-black text-gray-800 flex items-center gap-2 mr-4">
                  <UserCheck className="w-6 h-6 text-purple-600" /> Profil Majelis
                </h2>
                
                {subTabMajelis !== 'Infografis' && appUser?.role === 'admin' && (
                    <div className="flex items-center gap-2 relative">
                        <button onClick={() => { setFormData({ anak: [] }); setModalMode('addMajelis'); setShowMenuOps(false); }} className="flex items-center gap-1 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2.5 rounded-xl text-sm font-bold shadow-md active:scale-95">
                            <Plus className="w-4 h-4"/> Tambah Majelis
                        </button>
                        <div className="relative">
                            <button onClick={() => setShowMenuOps(!showMenuOps)} className="flex items-center gap-2 bg-purple-100 hover:bg-purple-200 text-purple-700 px-4 py-2.5 rounded-xl text-sm font-bold transition-all active:scale-95">
